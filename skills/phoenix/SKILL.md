---
name: phoenix
description: Build Phoenix perpetual futures integrations on Solana with the Rise SDK. Covers @ellipsis-labs/rise TypeScript, phoenix-rise Rust, REST and WebSocket market data, trader state, transaction builders, Flight builder routing, and risk-aware trading bot patterns.
---

# Phoenix Perpetuals Integration Guide

Use this skill when building applications, bots, analytics, vaults, or agent workflows that interact with Phoenix perpetual futures on Solana.
